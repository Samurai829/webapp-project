...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">Esto es un proyecto.
	    </p>
	    <p><strong>Address:</strong>  </p> 
	    <p><strong>Ph No: </strong>  +0-0000000000</p>
		<p><strong>E-Mail ID :</strong>  projects@ejemplo.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF "> <a href="#"  target="_blank" class="w3-hover-text-green"></a></p>
</footer>
